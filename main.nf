...
include { DOWNLOAD_GUNZIP_REFERENCES ; GTF_TO_PRED ; PRED_TO_BED ; 
          MAKE_GENE_TRANSCRIPT_MAP ; CLEAN_FOR_PACKAGING } from './modules/utilities.nf'
...
workflow {
    ...
    CLEAN_FOR_PACKAGING( DIFFERENTIAL_METHYLATION_ANALYSIS.out )
