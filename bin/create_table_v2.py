...
################################################################################
# Originally Adapted from create_table_v2.py
# Sent by Ana Uriarte Acuna, 2021_04_02
# Ended up here from Jonathan Oribello: https://github.com/asaravia-butler/GeneLab_Data_Processing/blob/jonathan-branch-2/RNAseq/Workflow_Documentation/NF_RCP-F/workflow_code/NF_RCP-F_1.0.0/bin/create_table_v2.py
# I changed the output from txt to tsv, because i'm not a monster, hehe
################################################################################
...
if __name__ == "__main__":
    ...
    # write back to file
    df_merged.to_csv(f"{args.accession}_metadata_table.tsv", sep="\t", index=False)
